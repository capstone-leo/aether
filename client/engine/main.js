    ...
    if (singlePlayerSession) {
      store.dispatch(
        dragInstrument(
          ...
          [objectSelect.position.x, objectSelect.position.y],
          objectSelect.soundType,
          e.object.soundIndex
        )
      );
      instruments.forEach((sceneInstrument) => {
      ...
      socket.emit('pitch_up_instrument', {
        id: objectSelect.reduxid,
        position: [objectSelect.position.x, objectSelect.position.y],
        soundType: objectSelect.soundType,
        soundIndex: objectSelect.soundIndex,
      });
    }
  }
}
